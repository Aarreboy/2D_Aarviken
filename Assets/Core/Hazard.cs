...
public class Hazard : MonoBehaviour
{
    ...
    /// If the temperature is high enough, the target might combust,
    /// if low enough, the target will become slow and brittle.
    /// </summary>
    ...
    /// <summary>
    /// Lightning or ice can cause something to get stuck in its current pose completely.
    /// </summary>
    public float stun;
